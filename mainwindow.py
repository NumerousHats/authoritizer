...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.selectauth_rb = QtGui.QRadioButton(self.centralWidget)
        self.selectauth_rb.setGeometry(QtCore.QRect(740, 40, 204, 20))
        self.selectauth_rb.setChecked(True)
        self.selectauth_rb.setObjectName(_fromUtf8("selectauth_rb"))
        self.buttonGroup = QtGui.QButtonGroup(MainWindow)
        self.buttonGroup.setObjectName(_fromUtf8("buttonGroup"))
        self.buttonGroup.addButton(self.selectauth_rb)
        self.createauth_rb = QtGui.QRadioButton(self.centralWidget)
        self.createauth_rb.setGeometry(QtCore.QRect(740, 330, 164, 20))
        self.createauth_rb.setObjectName(_fromUtf8("createauth_rb"))
        self.buttonGroup.addButton(self.createauth_rb)
        self.deleteauth_rb = QtGui.QRadioButton(self.centralWidget)
        self.deleteauth_rb.setGeometry(QtCore.QRect(740, 410, 170, 20))
        self.deleteauth_rb.setObjectName(_fromUtf8("deleteauth_rb"))
        self.buttonGroup.addButton(self.deleteauth_rb)
        self.buttonBox = QtGui.QDialogButtonBox(self.centralWidget)
        self.buttonBox.setGeometry(QtCore.QRect(900, 450, 164, 32))
        self.buttonBox.setStandardButtons(QtGui.QDialogButtonBox.Ok)
        self.buttonBox.setObjectName(_fromUtf8("buttonBox"))
        self.widget = QtGui.QWidget(self.centralWidget)
        self.widget.setGeometry(QtCore.QRect(740, 360, 177, 23))
        ...
        self.widget1.setGeometry(QtCore.QRect(750, 70, 308, 194))
        ...
        self.tophit_list = QtGui.QListWidget(self.widget1)
        font = QtGui.QFont()
        font.setPointSize(16)
        self.tophit_list.setFont(font)
        self.tophit_list.setObjectName(_fromUtf8("tophit_list"))
        self.horizontalLayout.addWidget(self.tophit_list)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.selectauth_rb.setText(_translate("MainWindow", "Select authority from top hits", None))
        self.createauth_rb.setText(_translate("MainWindow", "Create a new authority", None))
        self.deleteauth_rb.setText(_translate("MainWindow", "Delete current authority", None))
